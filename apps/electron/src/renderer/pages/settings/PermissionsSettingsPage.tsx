                  ...
                  <SettingsSection title={t('settings.permissions.aboutPermissions')}>
                    <SettingsCard className="px-4 py-3.5">
                      <div className="text-sm text-muted-foreground leading-relaxed space-y-1.5">
                        <p>
                          {t('settings.permissions.aboutPermissionsP1')}
                        </p>
                        <p>
                          {t('settings.permissions.aboutPermissionsP2')}
                        </p>
                        <p>
                          <button
                            type="button"
                    ...
                    <SettingsCard className="p-0">
                      {defaultPermissionsData.length > 0 ? (
                        ...
                        <div className="p-8 text-center text-muted-foreground">
                          <p className="text-sm">{t('settings.permissions.noDefaultPerms')}</p>
                          <p className="text-xs mt-1 text-foreground/40">
                            {t('settings.permissions.noDefaultPermsHint')} <code className="bg-foreground/5 px-1 rounded">~/.craft-agent/permissions/default.json</code>
                          </p>
                        </div>
                      )}
                    </SettingsCard>
                  ...
                  >
                    <SettingsCard className="p-0">
                      {customPermissionsData.length > 0 ? (
                        ...
                        <div className="p-8 text-center text-muted-foreground">
                          <p className="text-sm">{t('settings.permissions.noCustomPerms')}</p>
                          <p className="text-xs mt-1 text-foreground/40">
                            {t('settings.permissions.noCustomPermsHint')}
                          </p>
                        </div>
                      )}
                    </SettingsCard>
