              ...
              <SettingsSection title={t('settings.input.sending')} description={t('settings.input.sendingDesc')}>
                <SettingsCard>
                  <SettingsMenuSelectRow
                    ...
                    description={t('settings.input.sendMessageKeyDesc')}
                    value={sendMessageKey}
                    onValueChange={handleSendMessageKeyChange}
                    options={[
                      { value: 'enter', label: 'Enter', description: t('settings.input.enterDesc') },
                      { value: 'cmd-enter', label: isMac ? '⌘ Enter' : 'Ctrl+Enter', description: t('settings.input.cmdEnterDesc') },
                    ]}
                  />
                </SettingsCard>
              </SettingsSection>
