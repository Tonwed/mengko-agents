 ...
 * Includes only relevant items for the Mengko Agents app.
 *
 ...
 *
 * On Windows/Linux: Menu is hidden - all functionality is in the Mengko logo menu.
...
export async function rebuildMenu(): Promise<void> {
  ...
  // Users access menu via the Mengko logo dropdown in the app
  if (!isMac) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    ...(isMac ? [{
      label: 'Mengko Agents',
      submenu: [
        { role: 'about' as const, label: 'About Mengko Agents' },
        updateMenuItem,
        ...
        { type: 'separator' as const },
        { role: 'hide' as const, label: 'Hide Mengko Agents' },
        { role: 'hideOthers' as const },
        { role: 'unhide' as const },
        { type: 'separator' as const },
        { role: 'quit' as const, label: 'Quit Mengko Agents' }
      ]
    }] : []),
