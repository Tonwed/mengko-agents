...
/**
 * Load config defaults from ~/.mengko-agent/config-defaults.json
...
export function ensureConfigDir(): void {
  ...
  // Initialize bundled docs (creates ~/.mengko-agent/docs/ with sources.md, agents.md, permissions.md)
  initializeDocs();
 ...
 * Preset themes are stored at ~/.mengko-agent/themes/
 */
...
/**
 * Returns the path to the tool-icons directory: ~/.mengko-agent/tool-icons/
 */
